...
- [data-fetching.md](tanstack-query/data-fetching.md) - Advanced patterns
- [cache-strategies.md](tanstack-query/cache-strategies.md) - Cache management
- [mutation-patterns.md](tanstack-query/mutation-patterns.md) - Complex mutations
