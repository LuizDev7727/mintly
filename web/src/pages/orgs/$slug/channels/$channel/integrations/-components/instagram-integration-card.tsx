...
import { InstagramIcon } from "@/components/provider-icons";
import { deleteIntegrationHttp } from "@/http/integration/delete-ingration.http";
import { requestInstagramIntegrationUrlHttp } from "@/http/integration/request-instagram-integration-url.http";
import type { Integration } from "@/types/integration";

interface InstagramIntegrationCardProps {
    ...
    <div className="h-full">
      <div className="flex h-full flex-col rounded-md border p-5 shadow-sm">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="font-semibold leading-tight">Instagram</h3>
            </div>
          </div>
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Connect your Instagram account to publish clips and reach your
